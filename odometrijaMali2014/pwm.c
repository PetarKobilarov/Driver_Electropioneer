...
void CloseMCPWM(void)
{
    ...
    /*ugasi mostove
    Gasenje mostova se vrsi stavljanjem smera na nulu. Dakle svi INx pinovi se trebaju staviti na 0, od oba mosta
     */
    LATBbits.LATB14 = 0;//INA1
    LATBbits.LATB12 = 0;//INB1

    LATBbits.LATB11 = 0;//INA2
    LATBbits.LATB8 = 0;//INB2
}
